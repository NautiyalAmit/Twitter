...
select following_id from following where user_id='<jsp:getProperty
							name="bean2" property="user_id" />'
</sql:query>
<table border="1" width="100%">
		<tr>
			<th>People who you are following:</th>
			
		</tr>
		<c:forEach var="row" items="${result.rows}">
			<tr>
			<td><a href="ProfileServlet?id=${row.following_id}"> <c:out value="${row.following_id}"/></a></td>
			</tr>
			</c:forEach>
	</table></div>
